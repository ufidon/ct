...
🍎 Example: generate regular languages with CFG
---
- CFG1
  - ❶ S → Sa
  - ❷ S → ε
...
- Four of its words (ahh, aahh, abah,aahah) have two different possible derivations
...
- the TLT is infinite causing by X
  - but the language has only finitely many words {a,b}