...
🍎 Example 4
---
Given PDA₁ and PDA₂ in (p7) and suppose they generate L₁ and L₂,
Find PDA₃ accepts L₁+L₂. (p8)
...
- ❷ (optional) the complement of the `non-context-free language {aⁿbⁿaⁿ}` is the context-free language L below:
  - ${ L = M_{pq} + M_{qr} + M_{pr} + M_{rp} + M_{qr} + M_{rq} + M }$ is context-free since
    - ${ M_{pq}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } p>q\} }$ is CFL can be generated CFG₁:
      - S→AXA
      - X→aXb|ab (⊨aⁿbⁿ)
      - A→aA|a (⊨aa*)
    ...
    - ${ M_{qp}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } q>p\} }$ is CFL can be generated CFG₂:
      - S→XBA
      - X→aXb|ab (⊨aⁿbⁿ)
      - B→bB|b (⊨bb*)
      - A→aA|a (⊨aa*)
      - (aⁿbⁿ)(b⁺)(a⁺) = ${ a^p b^q a^r }$
    - ${ M_{pr}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } p>r\} }$ is CFL can be generated CFG₃:
      - S→AX
      - X→aXa|aBa (⊨aⁿbb*aⁿ)
      - B→bB|b (⊨bb*)
      - A→aA|a (⊨aa*)
      - (aa*)(aⁿbb*aⁿ) = ${ a^p b^q a^r }$
    - ${ M_{rp}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } r>p\} }$ is CFL can be generated CFG₄:
      - S→XA
      - X→aXa|aBa (⊨aⁿbb*aⁿ)
      - B→bB|b (⊨bb*)
      - A→aA|a (⊨aa*)
      - (aⁿbb*aⁿ)(aa*) = ${ a^p b^q a^r }$
    - ${ M_{qr}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } q>r\} }$ is CFL can be generated CFG₅:
      - S→ABX
      - X→bXa|ba (⊨bⁿaⁿ)
      - B→bB|b (⊨bb*)
      - A→aA|a (⊨aa*)
      - (a⁺)(b⁺)(bⁿaⁿ) = ${ a^p b^q a^r }$
    - ${ M_{rq}=\{a^p b^q a^r | p,q,r=1,2,3,⋯ \text{ and } r>q\} }$ is CFL can be generated CFG₆:
      - S→AXA
      - X→bXa|ba (⊨bⁿaⁿ)
      - A→aA|a (⊨aa*)
