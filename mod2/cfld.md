...
- for ℓ in 1 to `|x|=length(x)`, repeat 
  - let Pₗ = the set of producing nonterminals = Φ
  - factor x into substrings each of length ℓ
...
- find some sequence of productions that gener­ates the target word
...
- PDT₂ (p11) converts infix to postfix
