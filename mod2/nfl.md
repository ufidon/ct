...
- case 1: the second Z is a `descendant` of itself

| Grammar | Derivation | Derivation Tree |
|:---:|:---:|:---:|
| S→AZ <br>Z→BB <br>B→ZA <br>A→a <br>B→b | S⇒AZ <br>⇒aZ <br>⇒aBB <br>⇒abB <br>⇒abZA | ![n00](./img/n00.png) |


- case 2: the second B is NOT a `descendant` of itself

| Grammar | Derivation | Derivation Tree |
|:---:|:---:|:---:|
| S→AA <br>A→BC <br>C→BB <br>A→a <br>B→b | S⇒AA <br>⇒BCA <br>⇒bCA <br>⇒bBBA <br>⇒bbBA | ![n00](./img/n01.png) |

---

💡Demo 3
---
- Given a derivation tree of an CFG in CNF
  - ![n02](./img/n02.png)
...
- ![n03](./img/n03.png)
  ...
  - both X → BY and S → XY are used twice
...
NONULLPALINDROME has words shorter than 6 letters with self-embedding nonterminal such as `aabaa`:
- ![n04](./img/n04.png)
...
- the second X can begin a subtree exactly like the first X, and this procedure can be repeated infinitely
- ![n05b](./img/n05b.png)
- ![n05c](./img/n05c.png)
...
for `w=bbabbb` ∈ CFG1 and one of its possible derivation tree
- ![n06a](./img/n06a.png)
- A is `self-embedded`
- the subtree rooted at A can be repeated any number of times
  - ![n06b](./img/n06b.png)
...
- given such as derivation tree and one self-embedded nonterminals P whose first production is P→QR
  - ![n07a](./img/n07a.png)
- the triangle encloses the whole part of the tree generated from the `first P` down to where the `second P` is produced, divide w into these five parts
  - ![n07b](./img/n07b.png)
  ...
  - such as
    ...
    - ![n07d](./img/n07d.png)
    - ![n07e](./img/n07e.png)
- reiterating the productions inside the triangle n times generates `uvⁿxyⁿz`

| iterate twice | iterate 3 times |
|:---:|:---:|
| ![n07f](./img/n07f.png) | ![n07g](./img/n07g.png) |
...
word `abab` can be derived from G
- ![n08a](./img/n08a.png)
- there are 3 instances of self-embedded nonterminals
- such as self-embedded nonterminal Q
  - ![n08b](./img/n08b.png)
  - (u,v,x,y,z)=(a,ε,b,ab,ε)
- repeat the self-embedding twice
  - ![n08c1](./img/n08c1.png) ![n08c2](./img/n08c2.png)
  - (u,v²,x,y²,z)=(a,ε,b,(ab)²,ε)
- repeat the self-embedding three times
  - ![n08d1](./img/n08d1.png) ![n08d2](./img/n08d2.png)
  - (u,v³,x,y³,z)=(a,ε,b,(ab)³,ε) 
- repeat the self-embedding n times
  - ![n08e1](./img/n08e1.png) ![n08e2](./img/n08e2.png)
