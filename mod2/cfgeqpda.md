...
🍎 Example 3
---
The language PALINDROME (including ϵ) can be generated by the following CFG in CNF (p7)
...
- All branching, deterministic, or nondeterministic, occurs at RoH states, none at POP states, and every edge has only one label (no multiple labels)
  -  ❺ (p13) convert all branching at POP states into branching at RoH states
- `❺ case 1`: 
```mermaid
flowchart LR
  un1(("⋯"))
